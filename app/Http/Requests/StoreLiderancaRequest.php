...
class StoreLiderancaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'instagram.max' => 'O usuário do Instagram não pode ter mais de 30 caracteres.', // ⬅️ NOVO
            'instagram.regex' => 'O usuário do Instagram deve conter apenas letras, números, pontos e sublinhados.', // ⬅️ NOVO
